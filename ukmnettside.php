...
class UKMnettside extends Modul
{
	...
	public static function scripts_and_styles() {
		...
		wp_enqueue_script('UKMnettside_script',  UKMnettside::getPluginUrl() . 'ukmnettside.js',[ 'wp-color-picker']);
        wp_enqueue_style( 'wp-color-picker' );
		wp_enqueue_style( 'UKMnettside_style', UKMnettside::getPluginUrl() .'ukmnettside.css');
